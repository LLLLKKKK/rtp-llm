...
class RemoteREAPIPlugin:
    ...
    def _build_session_command(
        ...
        # `testpaths` and collects every CUDA/ROCm/PPU test in the tree → 45+
        ...
        if ci_profile:
            try:
                ...
                profile_cli_args = "-v --tb=short --timeout=300 "
        ...
        lines.append(f"        report.user_properties.append(('{_NODEID_PROPERTY}', item.nodeid))")
        ...
        for tier, n_workers, phase_mark in phases:
            ...
            lines.append(
                ...
                f"-p rtp_remote_nodeid_plugin {common} "
